    ...
    public class TestHelper
    {
        public static Player CreatePlayer()
        {
            var player = new Player()
                             {  Id = 6, FirstName = "Kaya",LastName = "Vena",Age = 27, Point = 3, EmailAddress = "kavena@yhoo.com", Date = DateTime.Now
                             };
            new Player() { Id = 5, FirstName = "siya", LastName = "mbambo", Age = 25, Point = 3, EmailAddress = "mbambos@yhoo.com", Date = DateTime.Now };          
            return player;
        } 
        ...
        public static Results CreateResults()
        {
            ...
            results._id = 1;
            results.HostId = 6;
            results.OppenentId = 5;
            results.OppnetBallsLeft = 5;
            results.HosBallsLeft = 3;
            results.BlackBallPayerId = 6;
